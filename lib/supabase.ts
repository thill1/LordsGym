...
// Supabase project URL (not secret). Anon key must come from env (GitHub secrets / .env.local).
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL || 'https://mrptukahxloqpdqiaxkb.supabase.co';
