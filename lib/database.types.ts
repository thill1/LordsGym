...
// Run: npx supabase gen types typescript --project-id ktzvzossoyyfvexkgagm > lib/database.types.ts
// Or use the Supabase dashboard to generate types:
// https://supabase.com/dashboard/project/ktzvzossoyyfvexkgagm/settings/api
