  ...
  return (
    <>
      <Section bg="image" bgImage="https://images.unsplash.com/photo-1540497077202-7c8a33801524?auto=format&fit=crop&w=1920&q=80" className="pt-32 pb-32 text-center">
        ...
        <p className="text-2xl max-w-2xl mx-auto">More than a gym. A movement.</p>
      </Section>

      <Section>
        <div className="max-w-4xl mx-auto space-y-12">
          <div>
            <h2 className="text-3xl font-bold mb-4 text-brand-gold">The Mission</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
             <div className="bg-neutral-100 dark:bg-neutral-800 p-8 rounded-lg">
                ...
                <ul className="space-y-2">
                  <li className="flex items-center"><span className="text-brand-gold mr-2">✦</span> Humility in Strength</li>
                  <li className="flex items-center"><span className="text-brand-gold mr-2">✦</span> Excellence in Service</li>
                  <li className="flex items-center"><span className="text-brand-gold mr-2">✦</span> Radical Generosity</li>
                  <li className="flex items-center"><span className="text-brand-gold mr-2">✦</span> Unwavering Faith</li>
                </ul>
             </div>
             <div>
               <img src="https://images.unsplash.com/photo-1571902943202-507ec2618e8f?auto=format&fit=crop&w=600&q=80" alt="Community" className="rounded-lg shadow-lg w-full h-full object-cover" />
             </div>
          </div>
          ...
          <div>
             ...
             <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
               <Card className="text-center">
                 ...
                 <p className="text-sm text-brand-gold uppercase tracking-wide mb-2">Head Coach</p>
               ...
               <Card className="text-center">
                 ...
                 <p className="text-sm text-brand-gold uppercase tracking-wide mb-2">Nutrition & Wellness</p>
               ...
               <Card className="text-center">
                 ...
                 <p className="text-sm text-brand-gold uppercase tracking-wide mb-2">Outreach Director</p>
